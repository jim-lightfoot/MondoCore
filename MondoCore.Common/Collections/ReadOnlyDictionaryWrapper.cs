...
namespace MondoCore.Common
{
    ...
    /// </summary>
    internal class ReadOnlyDictionaryWrapper<V> : IReadOnlyDictionary<string, object>
    {
        private readonly IReadOnlyDictionary<string, V> _dict;

        /****************************************************************************/
        public ReadOnlyDictionaryWrapper(IReadOnlyDictionary<string, V> dict)
        {
            _dict = dict;
        }
        ...
        /****************************************************************************/
        /****************************************************************************/
        private class MyEnumerator(IReadOnlyDictionary<string, V> dict) : IEnumerator<KeyValuePair<string, object>>
        {
